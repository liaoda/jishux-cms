...
class TagList
{
    ...
    function GetPageListDM($list_len,$listitem="info,index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $prepage.="<li><a class=\"pagenew\" href='".$purl."/$prepagenum/'>上一页</a></li>";
            $indexpage="<li><a class=\"pagenew\" href='".$purl."/1/'>首页</a></li>";
        }
        else
        {
//            $indexpage="<a disabled=\"disabled\"><</a>";
        ...
        {
            $nextpage.="<li><a class=\"pagenew\" href='".$purl."/$nextpagenum/'>下一页</a></li>";
            $endpage="<li><a class=\"pagenew\" href='".$purl."/$totalpage/'>末页</a></li>";
        }
        else
        {
            $endpage="<li><a disabled=\"disabled\">没有了</a></li>";
        }
        ...
        for($j; $j<=$total_list; $j++)
        {
            ...
            {
                $listdd.="<li><a href='".$purl."/$j/' class=\"pagenew\">".$j."</a></li>";
            }
        }
        $plist  =  '';
