...
class ListView
{
    ...
    function MakeHtml($startpage=1, $makepagesize=0, $isremote=0)
    {
        ...
        if($this->TypeLink->TypeInfos['isdefault']==-1)
        {
           ...
           // return '../plus/list-'.$this->TypeLink->TypeInfos['id'].'-1-1.html';
        }
     ...
     * @return    string
     */
    function GetArcList($limitstart=0,$row=10,$col=1,$titlelen=50,$infolen=250,
...
//            <li><a disabled="disabled"><</a></li>
        ...
        {
            $endpage="<li><a disabled=\"disabled\">没有了</a>";
        }
