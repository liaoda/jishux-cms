...
class SearchView
{
     ...
     * @return    string
     */
    function GetArcList($limitstart=0,$row=10,$col=1,$titlelen=80,$infolen=250,
...
//            <li><a disabled="disabled"><</a></li>
        ...
        {
            $endpage="<li><a disabled=\"disabled\">没有更多了</a></li>";
        }
        ...
        for($j; $j<=$total_list; $j++)
        {
            if($j == $this->PageNo)
            {
                $listdd.= "<li><span class=\"current\">$j</span></li>\r\n";
            }
            else
            {
                $listdd.="<li><a href='".$purl."PageNo=$j' class=\"pagenew\">".$j."</a></li>&nbsp;\r\n";
            }
        }
        ...
        {
            $plist.="<td width='38' style='display: inherit'><input type='text' name='PageNo' style='width:4rem;height:2.5rem;padding:.2rem .4rem' value='".$this->PageNo."' />\r\n";
            $plist.="<input type='submit' name='plistgo' value='GO' style='width:4rem;height:2rem;font-size:9pt;margin:.5rem 0' />\r\n";
        }
        $plist .= "</form>\r\n</tr>\r\n</table>\r\n";
        return $plist;
    }
